...
                        ResultSet rs = stmt.executeQuery("select * from 9091_sample_txt");
                        while (rs.next()) {
                                count++;
...
                                        if (year_sub.equals("1990")) {
                                                if (temp > max1 && temp != 9999)
                                                        max1 = temp;}
                                        if (year_sub.equals("1991")) {
...
                System.out.println("Maximum temperature in 1990 " + ": " + max1);
                System.out.println("Maximum temperature in 1991 " + ": " + max2);
